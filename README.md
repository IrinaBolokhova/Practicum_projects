...
**Описание проекта:** На основе исторических данных финансовой компании о стартапах определены приоритетные для вложения категории деятельности стартапов и ориентировочные суммы финансирования. Проведена предобработка данных. Построены диаграммы, гистограммы, боксплоты, линейные графики. Даны рекомендации для финансовой компании.
